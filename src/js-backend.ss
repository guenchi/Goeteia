...
(define (jp op args trees)
  ...
  (case op
    ...
    ((string-ref) (list "(((" (a 0) "[IU(" (a 1) ")])<<1)|1)"))
    ((string-set!)
     (list "((" (a 0) "[IU(" (a 1) ")]=IU(" (a 2) ")),VOID)"))
    ...
    ((vector-ref) (list "(" (a 0) "[IU(" (a 1) ")])"))
    ((vector-set!) (list "((" (a 0) "[IU(" (a 1) ")]=" (a 2) "),VOID)"))
    ...
    ((bytevector-u8-ref) (list "(" (a 0) ".u[IU(" (a 1) ")]<<1)"))
    ((bytevector-u8-set!)
     (list "((" (a 0) ".u[IU(" (a 1) ")]=IU(" (a 2) ")),VOID)"))
    ...
    ((%mem-u8-ref) (list "(MEMU[IU(" (a 0) ")]<<1)"))
    ((%mem-u8-set!)
     (list "((MEMU[IU(" (a 0) ")]=IU(" (a 1) ")),VOID)"))
    ((%mem-i32-ref) (list "(W(MEMV.getInt32(IU(" (a 0) "),true)))"))
    ((%mem-i32-set!)
     (list "((MEMV.setInt32(IU(" (a 0) "),IU(" (a 1) "),true)),VOID)"))
    ((%mem-f32-ref) (list "(new Fl(MEMV.getFloat32(IU(" (a 0) "),true)))"))
    ((%mem-f32-set!)
     (list "((MEMV.setFloat32(IU(" (a 0) ")," (a 1) ".v,true)),VOID)"))
    ((%mem-f64-ref) (list "(new Fl(MEMV.getFloat64(IU(" (a 0) "),true)))"))
    ((%mem-f64-set!)
     (list "((MEMV.setFloat64(IU(" (a 0) ")," (a 1) ".v,true)),VOID)"))
    ((%mem-size) "(MSIZE())")
    ...
    ((%f32x4-mul!)
     (list "(F4('*',IU(" (a 0) "),IU(" (a 1) "),IU(" (a 2) ")),VOID)"))
    ((%f32x4-scale!)
     (list "(F4SC(IU(" (a 0) "),IU(" (a 1) ")," (a 2) ".v),VOID)"))
    ((%f32x4-axpy!)
     (list "(F4AX(IU(" (a 0) "),IU(" (a 1) "),IU(" (a 2) ")," (a 3) ".v),VOID)"))
    ((%f32x4-dot)
