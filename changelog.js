// Render docs/CHANGELOG.md into #doc with marked; fall back to raw text.
// The same renderer manual.js uses -- one kind of page, one script shape.
...
fetch(SRC)
  ...
  .catch(() => fail('The changelog isn’t available yet.'));
