...
;; C02 (2026-09-06 review; written as a red witness at a52af3b, green
;; since): a top-level definition does not shadow a primitive of the
;; same name.
;;
;; REGRESSION GUARD.  Today every target answers 1: the call site is
