...
;; bound.  ⚠️ It sat above two other cells until it was measured, and
...
;; ⚠️ The header region is CLEARED first, and the declared length is
...
;; ⚠️ The gigabyte is written as four BYTES for the same reason the
