;; expect: 5
;; Shadowed-primitive family, inner lambda shape.  fl+ is shadowed by a
;; inner lambda binding, so in operator position it is that binding, a lambda
...
(display ((lambda (fl+) (zq (fl+ 1.0 2.0) 0.0)) (lambda (x y) 5)))
