;; expect: #t
;; C06 (2026-09-06 review; written as a red witness at a52af3b, green
;; since): the most negative fixnum divided by -1 does not become a
;; bignum.
;;
;; REGRESSION GUARD.  Today every target answers #f.  The quotient of
