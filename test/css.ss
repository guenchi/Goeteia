...
;; take variable arity -- (em 1)=1em whole, (em 0 92)=0.92em I.F.
(import (web css))
...
(and
 ...
 ;; fractions: two args = integer part . fractional part
 (t (css->string '((x (a (em 0 92))))) "x{a:0.92em;}")
 (t (css->string '((x (a (em 3 4))))) "x{a:3.4em;}")
 ...
 ;; calc and rgba (rgb parts bare integers; alpha a string)
