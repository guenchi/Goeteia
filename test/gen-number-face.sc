...
(define (header)
  (for-each (lambda (l) (display l) (newline))
   (list
    ...
    ";; implementation once spelled an infinity \"<big-flonum>\", and a text"
    ";; comparison called that a reader disagreement when only the spelling"
    ";; differed.  It spells them +inf.0 and -inf.0 now."
    ";;"
